...
class DeRingLeaderboardItem extends StatelessWidget {
  final String userId;
  final String firstName;
  final String lastName;
  final int deringScore;
  final String profileUrl;
  final int rank;
  final bool isCurrentUser;

  const DeRingLeaderboardItem({
    super.key,
    required this.userId,
    required this.firstName,
    required this.lastName,
    required this.deringScore,
    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          // DeRing score with trophy icon for top 3 players
          Row(
            children: [
              if (rank <= 3) ...[
