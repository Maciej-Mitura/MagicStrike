...
class StrikeStreakLeaderboardItem extends StatelessWidget {
  final String userId;
  final String firstName;
  final String lastName;
  final int strikeStreak;
  final String profileUrl;
  final int rank;
  final bool isCurrentUser;

  const StrikeStreakLeaderboardItem({
    super.key,
    required this.userId,
    required this.firstName,
    required this.lastName,
    required this.strikeStreak,
    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          // Strike streak with lightning icon
          Row(
            children: [
              if (rank <= 3) ...[
                // Lightning icon with different sizes and colors based on rank
                Icon(
                  Icons.bolt,
                  color: rank == 1
                      ? Colors.amber
